...
Patient.create(first_name: "Asim", middle_name: "Riaz", last_name: "Kaghzi", gender: "male", date_of_birth: "1968-03-01", phone: "4032749657")
...
RegQuestion.create(content: 'allergies to food or medication or any other substances',minimum_age: 0,gender: 'both')
RegQuestion.create(content: 'list of all medication taking currently, dosage, and frequency [include any food supplements and vitamins, and over the counter medicines]',minimum_age: 0,gender: 'both')
