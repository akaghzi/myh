...
class AllergiesControllerTest < ActionController::TestCase
  ...
  test "should create allergy" do
    assert_difference('Allergy.count') do
      post :create, allergy: { name: @allergy.name, patient_id: @allergy.patient_id, reaction: @allergy.reaction, type: @allergy.type }
    end
  ...
  test "should update allergy" do
    patch :update, id: @allergy, allergy: { name: @allergy.name, patient_id: @allergy.patient_id, reaction: @allergy.reaction, type: @allergy.type }
    assert_redirected_to allergy_path(assigns(:allergy))
  end
